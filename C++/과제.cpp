...
// ctrl + ~ = 해당 해더파일로 이동 [설정필요함]
(도구 -> 환경 -> 키보드 -> 편집기상활에맞는메뉴.코드창.헤더코드파일전환)
...
/*
	23.7.14
	과제1 : virtual 키워드와 가상 함수 테이블 조사

	과제2 : 인터페이스를 사용하는 이유 조사하기

	과제3 : SOLID 조사하기

	과제4 지렁이 게임 (아직 미완성.. 점수, 판정 등 추가 예정 / 기본만 구현함)
*/
